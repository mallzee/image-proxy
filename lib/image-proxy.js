...
var MAX_WIDTH = parseInt(process.env.MAX_WIDTH) || 2048;
var MAX_HEIGHT = parseInt(process.env.MAX_HEIGHT) || 2048;

module.exports = function () {

  app.get('/:url/:width/:height', function (req, res, next) {
    var width = req.params.width / 2
      , height = req.params.height / 2
